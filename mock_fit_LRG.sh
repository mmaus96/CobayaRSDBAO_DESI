...
export PYTHONPATH=${PYTHONPATH}:/pscratch/sd/m/mmaus/new_template/Cobaya_template
export PYTHONPATH=${PYTHONPATH}:/pscratch/sd/m/mmaus/new_template/Cobaya_template/rsd_likelihood
